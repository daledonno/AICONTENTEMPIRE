  ...
  const templates = [
    {
      ...
      description: "Step-by-step guide for teaching a skill",
    },
    {
      id: 2,
      name: "Tool Review",
      description: "In-depth analysis of software or AI tools",
    },
    {
      id: 3,
      name: "News & Analysis",
      description: "Breaking down recent AI developments",
    },
    {
      id: 4,
      name: "Problem-Solution",
      description: "Addressing pain points with AI solutions",
    },
    {
      id: 5,
      name: "Top 5 List",
      description: "Curated list of best tools or techniques",
    },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card">
          ...
          <p className="text-gray-400 mb-4">
            Create variations or related content based on this script.
          </p>
          <div className="space-y-3">
